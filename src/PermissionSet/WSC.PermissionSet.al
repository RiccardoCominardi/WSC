...
permissionset 81001 "WSC Permissions"
{
    ...
    Permissions =
         ...
         page "WSC Web Services Parameters" = X,
         ...
         page "WSC Web Services Log Param." = X,
         ...
         table "WSC Web Services Parameters" = X,
         ...
         table "WSC Web Services Log Param." = X,
         ...
         tabledata "WSC Web Services Parameters" = RIMD,
         ...
         tabledata "WSC Web Services Log Param." = RIMD;
}